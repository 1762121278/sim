                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element mylogo">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                               ...
                               <span>${sessionScope.activeUser.remark}</span>
                               <span class="text-muted text-xs block">${sessionScope.activeUser.ename}<b class="caret"></b></span>
                               </span>
                            </a>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <c:forEach items="${parent.children}" var="child">
                                        <li>
                                            <a class="J_menuItem" id="${child.name}"
                                               href="${pageContext.request.contextPath}${child.url}" data-index="0">${child.name}
                                            </a>
                                        </li>
                                    </c:forEach>
                                </ul>
