	    ...
	    <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="get" action="${pageContext.request.contextPath}/dept/addDept">
                    ...
                    <div class="ibox-content">                    	
                        ...
                        <div class="row">
                            ...
                            <table class="table table-striped list-table">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${sessionScope.pageDeptInfo.list}" var="dept">
                                        <tr>
                                            <td><input  type="checkbox" id="deptCheckBox"></td>
                                            <td>${dept.deptno}</td>
                                            <td>${dept.dname}</td>
                                            <td>${dept.local}</td>
                                            <td>
                        ...
                        <div class="row">
							...
							<div class="col-sm-7 text-right">
								<div class="btn-group">
								    <span>共有${sessionScope.pageDeptInfo.pages}页,当前是第${sessionScope.pageDeptInfo.pageNum}页</span>
	                                <a href='${pageContext.request.contextPath}/dept/showDeptInfo?pageNum=1'>首页</a>
	                                <a href='${pageContext.request.contextPath}/dept/showDeptInfo?pageNum=${sessionScope.pageDeptInfo.prePage}'>上一页</a>
	                                <a href='${pageContext.request.contextPath}/dept/showDeptInfo?pageNum=${sessionScope.pageDeptInfo.nextPage}'>下一页</a>
	                                <a href='${pageContext.request.contextPath}/dept/showDeptInfo?pageNum=${sessionScope.pageDeptInfo.pages}'>尾页</a>
	                            </div>
							</div>
                        </div>
                        </div>
